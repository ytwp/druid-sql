...
import wang.yeting.sql.dialect.oracle.ast.OracleDataTypeIntervalDay;
import wang.yeting.sql.dialect.oracle.ast.OracleDataTypeIntervalYear;
import wang.yeting.sql.dialect.oracle.ast.clause.*;
import wang.yeting.sql.dialect.oracle.ast.clause.ModelClause.*;
import wang.yeting.sql.dialect.oracle.ast.expr.*;
import wang.yeting.sql.dialect.oracle.ast.stmt.*;
import wang.yeting.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.NestedTablePartitionSpec;
import wang.yeting.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.TableSpaceItem;
import wang.yeting.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.UpdateIndexesClause;
import wang.yeting.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClause;
import wang.yeting.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClauseItem;
import wang.yeting.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.InsertIntoClause;
import wang.yeting.sql.dialect.oracle.ast.stmt.OracleSelectPivot.Item;
import wang.yeting.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.CheckOption;
import wang.yeting.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.ReadOnly;
