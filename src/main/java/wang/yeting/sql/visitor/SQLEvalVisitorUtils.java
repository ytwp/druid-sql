...
import wang.yeting.sql.dialect.db2.visitor.DB2EvalVisitor;
import wang.yeting.sql.dialect.mysql.visitor.MySqlEvalVisitorImpl;
import wang.yeting.sql.dialect.oracle.visitor.OracleEvalVisitor;
import wang.yeting.sql.dialect.postgresql.visitor.PGEvalVisitor;
import wang.yeting.sql.util.HexBin;
import wang.yeting.sql.util.Utils;
import wang.yeting.sql.visitor.functions.*;
...
public class SQLEvalVisitorUtils {
    ...
    public static Object getValue(SQLObject sqlObject) {
        if (sqlObject instanceof wang.yeting.sql.ast.expr.SQLNumericLiteralExpr) {
            return ((wang.yeting.sql.ast.expr.SQLNumericLiteralExpr) sqlObject).getNumber();
        }
    ...
    public static Object eval(DbType dbType, SQLObject sqlObject, List<Object> parameters, boolean throwError) {
        ...
        Object value;
        if (sqlObject instanceof wang.yeting.sql.ast.expr.SQLValuableExpr) {
            value = ((wang.yeting.sql.ast.expr.SQLValuableExpr) sqlObject).getValue();
        } else {
    ...
    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLMethodInvokeExpr x) {
    ...
    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLCharExpr x) {
        x.putAttribute(EVAL_VALUE, x.getText());
        return true;
    }

    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLHexExpr x) {
        String hex = x.getHex();
    ...
    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLBinaryExpr x) {
    ...
    public static SQLExpr unwrap(SQLExpr expr) {
        ...
        if (expr instanceof wang.yeting.sql.ast.expr.SQLQueryExpr) {
            SQLSelect select = ((wang.yeting.sql.ast.expr.SQLQueryExpr) expr).getSubQuery();
            if (select == null) {
                return null;
            }
    ...
    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLBetweenExpr x) {
    ...
    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLNullExpr x) {
        x.getAttributes().put(EVAL_VALUE, EVAL_VALUE_NULL);
        return false;
    }

    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLCaseExpr x) {
        Object value;
        ...
        for (wang.yeting.sql.ast.expr.SQLCaseExpr.Item item : x.getItems()) {
    ...
    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLInListExpr x) {
    ...
    private static boolean isAlwayTrueLikePattern(SQLExpr x) {
        if (x instanceof wang.yeting.sql.ast.expr.SQLCharExpr) {
            String text = ((wang.yeting.sql.ast.expr.SQLCharExpr) x).getText();
    ...
    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLNumericLiteralExpr x) {
        x.putAttribute(EVAL_VALUE, x.getNumber());
        return false;
    }

    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLVariantRefExpr x) {
        if (!"?".equals(x.getName())) {
            return false;
        }
    ...
    public static boolean visit(SQLEvalVisitor visitor, wang.yeting.sql.ast.expr.SQLIdentifierExpr x) {
